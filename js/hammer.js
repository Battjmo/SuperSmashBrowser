const hammer = {
  activated: false,
  hammer1: chrome.runtime.getURL("images/hammer.png"),
  hammer2: chrome.runtime.getURL("images/hammerSideways.png"),
  ...
  activateTargetMode: async function () {
    ...
    const tab = await hammer.getCurrentTab();
    setTimeout(function () {
  ...
  draw: function (canvas, x, y) {
    ...
    smashed1.src = chrome.runtime.getURL("./images/smashed_1.png");
    smashed2.src = chrome.runtime.getURL("./images/smashed.png");
    smashed3.src = chrome.runtime.getURL("./images/smashed_2.png");
    smashed4.src = chrome.runtime.getURL("./images/smashed_3.png");
